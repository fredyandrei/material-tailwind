---
title: What is Tailwind CSS - Horizon UI
...
It is a utility-first CSS framework for rapidly building custom designs.
...
Check out more on the official [Tailwind CSS website](https://tailwindcss.com/?ref=horizon-ui.com).

<br />
Also, you can check out the official [Tailwind CSS Tutorials](https://tailwindcss.com/docs/installation?ref=horizon-ui.com).
