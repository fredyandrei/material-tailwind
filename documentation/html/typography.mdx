---
title: Tailwind CSS Typography - Horizon UI
...
<ComponentCard id='colors'>
  <div className='text-left'>
    <h1 className='text-primary-500'>Horizon UI</h1>
    <h1 className='text-blue-500'>Horizon UI</h1>
    <h1 className='text-green-500'>Horizon UI</h1>
    <h1 className='text-orange-500'>Horizon UI</h1>
    <h1 className='text-red-500'>Horizon UI</h1>
    <h1 className='text-dark-500'>Horizon UI</h1>
  </div>
</ComponentCard>
```html showLineNumbers
<h1 class='text-primary-500'>Horizon UI</h1>
<h1 class='text-blue-500'>Horizon UI</h1>
<h1 class='text-green-500'>Horizon UI</h1>
<h1 class='text-orange-500'>Horizon UI</h1>
<h1 class='text-red-500'>Horizon UI</h1>
<h1 class='text-dark-500'>Horizon UI</h1>
```
<br />
<br />
