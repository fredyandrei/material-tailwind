  ...
  <div className='w-1/2 my-10'>
    <div className='card'>
      ...
      <div className='card-body'>
        <a href='#'>
          <h4 className='font-medium'>Horizon UI</h4>
        </a>
        <p className='mb-4 opcacity-60'>
...
<div class="card">
  ...
  <div class="card-body">
    <a href="#">
      <h4 class="font-medium">Horizon UI</h4>
    </a>
    <p class="mb-3 opcacity-60">
...
<ComponentCard id='card image inside'>
  <div className='w-2/3 my-10'>
    <div className='card'>
      ...
      <div className='card-body'>
        <span className='font-bold uppercase text-orange-500 text-sm'>Hub</span>
        <a href='#'>
          <h5 className='mt-2 font-medium'>Horizon UI</h5>
        </a>
        <p className='mb-3'>
          The time is now for it to be okay to be great. People in this world
          shun people for being great. For being a bright color. For standing
      ...
      <div className='card-footer'>
        <div className='flex'>
          ...
          <div className='ml-3'>
            <span className='font-bold mb-0 text-blue-grey-700'>Mathew</span>
            <p className='text-xs mb-0'>Posted on 28 February</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="card">
  ...
  <div class="card-body">
    <span class="font-bold uppercase text-orange-500 text-sm">Hub</span>
    <a href="#">
      <h5 class="mt-2 font-medium">Horizon UI</h5>
    </a>
    <p class="mb-3">
      The time is now for it to be okay to be great. People in this world shun
      people for being great. For being a bright color. For standing out.
  ...
  <div class="card-footer">
    <div class="flex">
      ...
      <div class="ml-3">
        <span class="font-bold mb-0 text-blue-grey-700">Mathew</span>
        <p class="text-xs mb-0">Posted on 28 February</p>
      </div>
    </div>
  </div>
</div>
...
<ComponentCard id='card signin'>
  <div className='w-1/2 my-10'>
    <div className='card'>
      <div className='card-header mx-4 -mt-6'>
        <div className='bg-primary-500 shadow-primary rounded-lg py-3 pe-1'>
...
<div class="card">
  <div class="card-header mx-4 -mt-6">
    <div class="bg-primary-500 shadow-primary rounded-lg py-3 pe-1">
    ...
    <div className='card card-plain'>
      <div className='flex'>
        ...
        <div className='w-2/3 card-body'>
          <span className='text-blue-500 font-bold uppercase'>Startups</span>
          <a href='#'>
            <h3 className='mt-4'>
...
<div class="card card-plain">
  <div class="flex">
    ...
    <div class="w-2/3 card-body">
      <span class="text-blue-500 font-bold uppercase">Startups</span>
      <a href="#">
      ...
      <span>by <span class="font-bold">Megan Rose</span>, 2 days ago</span>
    </div>
  </div>
</div>
```
