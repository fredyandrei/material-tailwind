---
title: Tailwind CSS Alert - Horizon UI
...
<ComponentCard id='alert'>
  <div className='alert alert-primary w-full'>Alert primary</div>
</ComponentCard>

```html showLineNumbers
<div class="alert alert-primary w-full">Alert primary</div>
```
...
<ComponentCard id='alert with gradient'>
  <div className='alert alert-gradient alert-primary w-full'>Alert primary</div>
...
```html showLineNumbers
<div class="alert alert-gradient alert-primary w-full">Alert primary</div>
